 ...
 * exito se guarda los datos del destino en la estructura client y en proxySocket para
 * poder enviar datos
...
int main(int argc, char* argv[])
{
      ...
      int proxySocket = crear_conexion(IP_PROXY, PUERTO_PROXY);
      ...
      for (;;)
      {
            ...
            if(ticks == 60)
            {
                ...
                bytes_sent = send(proxySocket, buf, len, 0);
                ...
                recsize = recv(proxySocket, (void *)buf, BUFFER_LENGTH, 0);
                if (recsize > 0)
                {
